      ...
      <div className={styles.CreditFooter}>
        ...
        <div className={styles.CreditText}>
          <div className={styles.Crawl}>
            ...
            <p>
              Prosjektet er utviklet av Team 60, og er ment for å være en
              web-basert filmplakat- utstilling som en homage til noen av de
              beste filmene noensinne laget.
            </p>
            <p>
              Dette valget ble tatt grunnet gruppemedlemmenes felles kjærlighet
              for gode filmer, og et ønske om å hylle både komponistene og
              regissørene.
            </p>
          </div>
        </div>
